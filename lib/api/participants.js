 ...
 *     add       POST    tournaments/:tournament/participants/:participant_id/check_in
 *   </pre>
 */
...
Participants.prototype.add = function(obj) {
	obj.path = '/' + this.options.get('subdomain') + obj.id + '/participants/' + obj.participant_id + '/check_in';
	delete obj.id;
  delete obj.participant_id;
	obj.method = 'POST';
	this.makeRequest(obj);
